...
int main() {
    ...
    readMatrix(matA, "matrix_input.txt", n);
    readMatrix(matB, "matrix_input.txt", n);
    std::cout << "Matrix A:-\n";
    printMatrix(matA, n);
    std::cout << "Matrix B:-\n";
    printMatrix(matB, n);
    Add(matA, matB, result, n);
    std::cout << "Matrix addition:-\n";
    printMatrix(result, n);
    Sub(matA, matB, result, n);
    std::cout << "Matrix subtraction:-\n";
    printMatrix(result, n);
    multiply(matA, matB, result, n);
    std::cout << "Matrix addition:-\n";
    printMatrix(result, n);
    transpose(matA, result, n);
